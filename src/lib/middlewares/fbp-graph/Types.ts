import type { PlottyComponentMetadata } from "$lib/types/plotty";
...
// HACK modification of NoFlo metadata type
// export type GraphNodeMetadata = PropertyMap;
export type GraphNodeMetadata = PlottyComponentMetadata;
export type GraphNode = {
    id: GraphNodeID,
    component: string,
    metadata: GraphNodeMetadata,    // Metadata compulsory in ploTTY
}
